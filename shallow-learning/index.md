...
- **Node2vec:**
  ...
  - Two different embeddings will be generated by \textit{ENCODER} based on a node's role as a centre or context node. That is for each node $v \in V$,<br /> 
  ...
  - The optimal node embeddings will be learned by minimizing the cross-entropy loss function written as: <br />
    ...
    That is, the objective function is the negative logarithm of equation \ref{eqn 12}.
- **DeepWalk:**
  Study on your own
